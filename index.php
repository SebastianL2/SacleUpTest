...
<body  class="bg-stone-50">
    ...
    <div id="mainContainer" class="mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl text-center container">
         <a href="#display1"class="font-black text-center break-normal text-2xl md:text-3xl mx-auto my-4 px-2">
          Tap Below To Qualify</a>
        <img class="mx-auto my-2 w-full md:w-3/4" src="assets/images/hero.jpg" />
        <p class="my-3 md:text-xl" style="text-align: left;">
        Many elderly Americans are quickly updating their 2024 Medicare plans to obtain a $2,500 spending card. This card allows them to <strong> purchase goods at numerous stores.</strong>.
        </p>
        <p class="my-3 md:text-xl" style="text-align: left;">
        Unfortunately, a large number of seniors might lose the opportunity to secure this card as the registration period is drawing to a close. Ensure you're eligible by responding to two questions below <strong>before it's too late.</strong>
        </p>
        <div>
            <div id="display1" class="md:mt-8 mt-4">
                ...
                <div class="grid grid-cols-1  gap-6">
                   <a id="btn-3" href="no-qualify.php" class="flex justify-center bg-green-500 hover:bg-green-500 tracking-wide text-white font-bold rounded-2xl w-3/4 mx-auto border-b-2 border-green-500 uppercase shadow-md md:py-6 py-4 md:text-2xl px-6 items-center">
                     Under 64
                   </a>
    ...
    <div id="display4" class="hidden hidden mx-auto md:pt-4 pt-1 px-4 md:px-0 max-w-5xl container ">
        <div class="p-6 border-t-2 border-blue-500 mt-4 bg-gray-300 text-center shadow-xl">
            <h3 class="text-xl md:text-2xl font-bold text-blue-500 mb-4">
                Congratulations!
            </h3>
            <p class="text-xl md:text-2xl font-bold mb-4">
                You Pre-Qualify For <span class="text-blue-600">The Healthy Allowance Card!</span>
            </p>
            <p class="">
             Don't miss out - Speak to an official agent to claim your benefit card now.
            </p>
    ...
    <footer class="footer mt-12 footer-center p-4 mt-12 mb-2 text-center max-w-6xl mx-auto text-xs">
        <div class="grid grid-flow-col gap-3 md:w-1/3 mx-auto my-8">
            <a class="link link-hover" href="https://goldenyearsbenefits.com/terms"> Terms & Conditions </a>
            <p class="text-blue-500">|</p>
            <a class="link link-hover" href="https://goldenyearsbenefits.com/privacy"> Privacy Policy </a>

            <p class="text-blue-500">|</p>
            <a class="link link-hover" href="https://goldenyearsbenefits.com/privacy.php#caresidents"> CCPA </a>
        </div>
        <div class="mt-8">
            <p>Copyright
                <?php echo $domainName ?> © 2024 - All right reserved
            </p>
        </div>
    </footer>
